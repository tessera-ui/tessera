...
//!
//! ```rust,ignore
//! use tessera::cursor::CursorState;
...
///
/// ```rust,ignore
/// use tessera::cursor::{CursorState, CursorEventContent};
/// use tessera::PxPosition;
///
/// let mut cursor_state = CursorState::default();
///
...
impl CursorState {
    ...
    ///
    /// ```rust,ignore
    /// use tessera::cursor::{CursorState, CursorEvent, CursorEventContent, PressKeyEventType};
...
///
/// ```rust,ignore
/// use tessera::cursor::{CursorEvent, CursorEventContent, PressKeyEventType};
/// use std::time::Instant;
///
/// let event = CursorEvent {
///     timestamp: Instant::now(),
...
///
/// ```rust,ignore
/// use tessera::cursor::ScrollEventConent;
///
...
///
/// ```rust,ignore
/// use tessera::cursor::{CursorEventContent, PressKeyEventType, ScrollEventConent};
///
...
impl CursorEventContent {
    ...
    ///
    /// ```rust,ignore
    /// use tessera::cursor::CursorEventContent;
...
///
/// ```rust,ignore
/// use tessera::cursor::PressKeyEventType;
///
/// match button_type {
