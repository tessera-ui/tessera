...
//!
//! ```rust,ignore
//! use tessera::{DrawCommand, DrawablePipeline, PxPosition, PxSize};
//! use wgpu;
//!
...
//!
//! These pipelines are registered in `tessera_basic_components::pipelines::register_pipelines()`.
//!
...
///
/// ```rust,ignore
/// use tessera::renderer::drawer::PipelineRegistry;
///
