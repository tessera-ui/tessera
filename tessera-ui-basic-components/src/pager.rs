...
/// use tessera_ui_basic_components::pager::{PagerArgs, horizontal_pager};
...
/// ```
/// use tessera_ui::{remember, tessera};
/// use tessera_ui_basic_components::pager::{
///     PagerArgs, PagerController, horizontal_pager_with_controller,
/// };
/// use tessera_ui_basic_components::text::text;
///
/// #[tessera]
...
/// ```
/// use tessera_ui::{remember, tessera};
/// use tessera_ui_basic_components::pager::{PagerArgs, vertical_pager};
/// use tessera_ui_basic_components::text::text;
///
/// #[tessera]
/// fn demo() {
...
/// use tessera_ui::{remember, tessera};
/// use tessera_ui_basic_components::pager::{
///     PagerArgs, PagerController, vertical_pager_with_controller,
/// };
/// use tessera_ui_basic_components::text::text;
///
/// #[tessera]
