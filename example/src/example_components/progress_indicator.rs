...
use tessera_ui::{Color, Dp, Modifier, remember, retain, shard};
#[shard]
    ...
    lazy_column(
        &LazyColumnArgs::default()
            ...
            .content(move |scope| {
                scope.item(|| {
                    text(&TextArgs::from(
                        "Progress indicators (Material 3).".to_string(),
                    ))
                });
                scope.item(|| spacer(&SpacerArgs::new(Modifier::new().height(Dp(12.0)))));
                scope.item(|| text(&TextArgs::from("Linear (determinate).".to_string())));
                scope.item(move || {
                    linear_progress_indicator(
                ...
                scope.item(|| spacer(&SpacerArgs::new(Modifier::new().height(Dp(12.0)))));
                scope.item(|| text(&TextArgs::from("Adjust progress value:".to_string())));
                scope.item(move || {
                    slider(
                        &SliderArgs::default()
                ...
                scope.item(|| text(&TextArgs::from("Linear (indeterminate).".to_string())));
                scope.item(|| {
                    linear_progress_indicator(
                        &LinearProgressIndicatorArgs::default()
                            .modifier(Modifier::new().width(Dp(240.0))),
                ...
                scope.item(|| spacer(&SpacerArgs::new(Modifier::new().height(Dp(24.0)))));
                scope.item(|| text(&TextArgs::from("Circular (determinate).".to_string())));
                scope.item(move || {
                ...
                scope.item(|| spacer(&SpacerArgs::new(Modifier::new().height(Dp(24.0)))));
                scope.item(|| text(&TextArgs::from("Circular (indeterminate).".to_string())));
                scope.item(|| {
                    circular_progress_indicator(
