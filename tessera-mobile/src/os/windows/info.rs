...
use windows::Win32::System::{
    SystemInformation::{
        ...
        VER_SERVICEPACKMAJOR, VerSetConditionMask, VerifyVersionInfoW,
    },
...
type VersionInfo = (&'static str, u32, u32, u16, u8, Option<u32>);

// (name, major_version, minor_version, service_pack, product_type,
// build_number)
const VERSION_LIST: &[VersionInfo] = &[
