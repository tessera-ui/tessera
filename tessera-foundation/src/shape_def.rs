//! Shape definitions shared by foundational visual APIs.
//!
//! ## Usage
//!
//! Describe rounded rectangles and ellipses for surfaces, outlines, and effect
//! pipelines.
...
impl Default for Shape {
    ...
    ///
    /// ```
    /// use tessera_foundation::shape_def::{RoundedCorner, Shape};
